...
(function (a) {
  ...
  a.extend(m.prototype, {
    ...
    _columnsVisiblity: function (b) {
      var d = this.s.dt,
        ...
        l = a.map(c, function (c, h) {
          return !1 === d.column(h).visible()
            ? "not-visible"
            : c.auto && null === c.minWidth
            ? !1
            : !0 === c.auto
            ? "-"
            : -1 !== a.inArray(b, c.includeIn);
        }),
        r = 0;
      var h = 0;
      ...
      for (e = f.length; h < e; h++) {
        ...
        "-" === l[g] &&
          !c[g].control &&
          c[g].minWidth &&
          (k || 0 > r - c[g].minWidth ? ((k = !0), (l[g] = !1)) : (l[g] = !0),
          (r -= c[g].minWidth));
      }
      f = !1;
      h = 0;
      ...
      h = 0;
      for (e = c.length; h < e; h++)
        c[h].control && (l[h] = f), "not-visible" === l[h] && (l[h] = !1);
    ...
    _classLogic: function () {
      var b = this,
        ...
        g = function (a, c, g, l) {
          if (!g) e[a].includeIn.push(c);
            ...
            for (l = b._find(c).width, c = 0, g = d.length; c < g; c++)
      ...
      e.each(function (b, c) {
        for (
          var e = b.className.split(" "), f = !1, h = 0, l = e.length;
          h < l;
          h++
        ) {
          var k = a.trim(e[h]);
          if ("all" === k) {
            f = !0;
            b.includeIn = a.map(d, function (a) {
              return a.name;
            });
            return;
          }
          ...
          a.each(d, function (a, b) {
            ...
            var d = k.match(
              new RegExp(
                "(min\\-|max\\-|not\\-)?(" + a[0] + ")(\\-[_a-zA-Z0-9])?"
              )
            );
            d &&
              ((f = !0),
              d[2] === a[0] && d[3] === "-" + a[1]
                ? g(c, b.name, d[1], d[2] + d[3])
                : d[2] !== a[0] || d[3] || g(c, b.name, d[1], d[2]));
          });
        }
        f || (b.auto = !0);
      });
    ...
    _detailsDisplay: function (b, d) {
      ...
      if (f && !1 !== f.type) {
        ...
        (!0 !== g && !1 !== g) ||
          a(e.table().node()).triggerHandler("responsive-display.dt", [
            e,
            b,
            g,
            d,
    ...
    _detailsInit: function () {
      ...
      if (e !== n || null !== e)
        a(d.table().body()).on(
          ...
          function (c) {
            if (
              a(d.table().node()).hasClass("collapsed") &&
              -1 !==
                a.inArray(
                  a(this).closest("tr").get(0),
              ...
              "click" === c.type
                ...
                : "mouseup" === c.type &&
                  a(this).trigger("blur").css("outline", "");
            }
          }
        );
    },
    ...
    _redrawChildren: function () {
      var a = this,
        d = this.s.dt;
      d.rows({ page: "current" }).iterator("row", function (b, e) {
        d.row(e);
        a._detailsDisplay(d.row(e), !0);
      });
    },
    _resize: function (b) {
      var d = this,
      ...
      p &&
        ...
        a(c.table().node()).trigger("responsive-resize.dt", [
          c,
          this.s.current,
        ]),
        0 === c.page.info().recordsDisplay &&
          a("td", c.table().body()).eq(0).attr("colspan", q));
    ...
    _resizeAuto: function () {
      ...
      if (
        ...
        "inline" === this.c.details.type &&
          a(c).addClass("dtr-inline collapsed");
  ...
  m.display = {
    ...
    modal: function (b) {
      return function (d, c, e) {
            ...
            k = a('<div class="dtr-modal"/>')
              .append(
                a('<div class="dtr-modal-display"/>')
                  ...
                  .append(
                    a('<div class="dtr-modal-close">&times;</div>').click(
                      function () {
                        f();
                      }
                    )
        ...
        b &&
          b.header &&
          a("div.dtr-modal-content").prepend("<h2>" + b.header(d) + "</h2>");
      };
    },
  };
  var q = {};
        ...
        a.each(c, function (c, d) {
          d.hidden &&
            (a(
              ...
              .append(
                a('<span class="dtr-data"/>').append(
                  p(b, d.rowIndex, d.columnIndex)
                )
              )
              .appendTo(e),
            (f = !0));
  ...
  u.register("responsive.hasHidden()", function () {
    ...
    return b._responsive
      ? -1 !== a.inArray(!1, b._responsive._responsiveOnlyHidden())
      : !1;
  });
  u.registerPlural(
  ...
  a(g).on("preInit.dt.dtr", function (b, d, c) {
    "dt" === b.namespace &&
      (a(d.nTable).hasClass("responsive") ||
        a(d.nTable).hasClass("dt-responsive") ||
        d.oInit.responsive ||
        t.defaults.responsive) &&
      ((b = d.oInit.responsive),
