...
/**
 * Metanotify_Setup_ToS
 *
 * Show the Terms of Use page.
 */
final class Metanotify_Setup_ToS
{
	/**
	 * Singleton
	 *
	...
	public static function init()
	{
		...
		add_action('admin_menu', array($self, 'add_menu_page'),40);
	...
	public function add_menu_page()
	{
		...
		'metanotify-settings', // The ID of the parent menu item
		'Meta Notify', // Text displayed in the submenu
		'Terms of Use', // Text displayed in the page title and header
		'manage_options',
		'metanotify-tos',
		[$this, 'render']);
	}
	...
	// 	add_submenu_page(
	// 		'metanotify-tos', // The ID of the parent menu item
	// 		'Meta Notify', // Text displayed in the submenu
	// 		'Terms of Use', // Text displayed in the page title and header
	// 		'manage_options',
	// 		'metanotify-tos',
		...
		<div class="wrap metanotify-tou-page">
			...
			<ol>
				...
				<li><strong>Cookies and Similar Technologies</strong>. e collect Personal Data via cookies, pixel tags, or
					...
					information on our use of cookies, please read our <a href="https://rocketreach.co/cookies"
			...
			<h2>Complaints</h2>
			<p>If you wish to lodge a complaint about how we process your Personal Data, please contact us at <a
					href="mailto:privacy@januus.io">privacy@januus.io</a>. We will endeavor to respond to your complaint as soon
				as possible. You may also lodge a claim with the data protection supervisory authority in the EU country in
				which you live or work, or where you believe we have infringed data protection laws.</p>
			<h2>Contact Us</h2>
			<p>Digital Governance Services is the entity responsible for the processing of your Personal Data and for the
				purpose of the European Union’s General Data Protection Regulation, is the data controller in respect of the
				processing of your Personal Data. If you have any questions or comments about this Policy, our privacy
				practices, or if you would like to exercise your rights with respect to your Personal Data, please contact us by
			...
			<p>In addition, you may contact our data protection officer at <a
					href="mailto:privacy@januus.io">privacy@januus.io</a>.</p>
		</div>
		<?php
	}
	...
	public function enqueue_assets($hook_name)
	{
		...
		wp_add_inline_style('dashicons', '#wpcontent #wpbody p,#wpcontent #wpbody li {font-size:14px}#wpcontent #wpbody #wpbody-content .notice {display: none}.wp-admin .metanotify-tou-page h2 {font-size:1.75em}#wpcontent #wpbody li{list-style:disc}#wpcontent #wpbody .nested-list li {list-style:circle}');
	}
}

// Initialize the Singleton.
Metanotify_Setup_ToS::init();