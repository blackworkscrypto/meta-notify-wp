...
// Create a widget 1
//
CSF::createWidget('metanotify_csf_widget_example_1', array(
...
//
if (!function_exists('metanotify_csf_widget_example_1')) {
  function metanotify_csf_widget_example_1($args, $instance)
  {
